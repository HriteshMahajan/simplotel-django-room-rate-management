# Generated by Django 4.2.13 on 2024-05-30 20:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_rate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.roomrate')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.discount')),
                ('room_rate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.roomrate')),
            ],
        ),
    ]
